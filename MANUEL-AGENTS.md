...
- Bouton **GPS** : suit ta position en temps réel et indique le **site le plus proche** et la distance. Un **point bleu** (façon Google Maps) marque ta position exacte sur la carte, entouré d'un cercle indiquant la précision réelle du signal — plus le cercle est petit, plus la position est fiable (un grand cercle veut souvent dire qu'on est en intérieur, où le téléphone se repère par Wi-Fi plutôt que par satellite : sortir à ciel ouvert améliore nettement la précision).
